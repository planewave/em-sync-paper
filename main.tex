...
We will compare the TDO and CFO estimation variance between the EM and ML algorithms.
...
Next, the performance of the CFO estimation in presence of AWGN will be evaluated.
