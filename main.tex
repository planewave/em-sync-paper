...
\begin{figure}[htbp]
\centering
\subfigure[Timing instances on a typical eyediagram]{
\label{fig:eye_diag}
\includegraphics[width=3.1in]{pic/eye-ent-a.eps}}
% \hspace{0.2in} % 两图间距
\subfigure[Signal probability distribution at four timing instances]{
\label{fig:sig_prob}
\includegraphics[width=3.1in]{pic/eye-ent-b.eps}}
...
% 
% It is difficult to build an analytical relationship between the eye diagram entropy and the timing instance, and I don't think it is necessary, but the reviewer asked for it...
% Maybe I need spend some time working on it? an appendix is a good place for the derivation 
% 
% ^.
...
% 
% OK I will talk about some background of the kernel method 
% 
% ^.
